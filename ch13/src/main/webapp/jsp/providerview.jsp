...
<%@include file="/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>营业执照：</strong><img style="width:150px" src="${pageContext.request.contextPath }/${provider.license}"/></p>
            <p><strong>组织机构代码证：</strong><img style="width:150px" src="${pageContext.request.contextPath }/${provider.certificate}"/></p>
