...
<%@include file="/jsp/common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/provider/changeProviderInfo">
              <!--div的class 为error是验证错误，ok是验证成功-->
              <input type="hidden" name="id" id="proid" value="${provider.id }"> 
              <div class="">
			...
			<font color="red"></font>
              ...
              <div>
                    ...
                    <img style="width:150px" src="${pageContext.request.contextPath }/${provider.license}"/>
                    <input type="file" name="photos" id="license"> 
                </div>
                <div>
                    <label for="cretificate">组织机构代码证：</label>
                    <img style="width:150px" src="${pageContext.request.contextPath }/${provider.certificate}"/>
                    <input type="file" name="photos" id="cretificate"> 
                </div>
